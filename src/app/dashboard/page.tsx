  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <section className="mb-8 rounded-[28px] border border-slate-200 bg-gradient-to-r from-slate-900 via-indigo-900 to-violet-900 p-7 text-white shadow-[0_24px_60px_rgba(79,70,229,0.28)]">
        ...
        <div id="overview" className="grid gap-6 md:grid-cols-3">
          <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 text-3xl font-black tracking-tight text-slate-900">{Math.min(100, 78 + enrollments.length * 6)}%</div>
          ...
          <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 text-3xl font-black tracking-tight text-slate-900">{enrollments.length}</div>
          ...
          <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 text-3xl font-black tracking-tight text-slate-900">{totalProgress}%</div>
        ...
        <aside className="space-y-8">
          <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-3 text-sm text-slate-600">
              ...
              <div className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2.5">
                <span>Email</span>
                <span className="font-semibold text-slate-900">{session.user.email ?? "student@cognive.academy"}</span>
              </div>
              <div className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2.5">
                <span>Password</span>
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-black text-slate-900">Lecture room</h2>
      ...
      <section id="transactions" className="mt-10 rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-black tracking-tight text-slate-900">My Transactions</h2>
