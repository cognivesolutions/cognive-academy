    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-6 py-12">
      <div className="w-full max-w-2xl rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <p className="mt-4 text-lg text-slate-600">
          You have successfully created your Cognive Academy account. Start exploring courses and continue your learning journey.
        </p>
        ...
        <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
          ...
          <Link href="/dashboard" className="rounded-full border border-slate-300 bg-white px-6 py-3 font-semibold text-slate-800 hover:bg-slate-50">
            Go to dashboard
          </Link>
        </div>
      </div>
